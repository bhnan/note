...
---
$\begin{align*}S^2&=\frac{1}{n-1}\sum\limits_{i=1}^{n}(X_i-\bar{X})\\&=\frac{1}{n-1}\sum\limits_{i=1}^{n}X_i^2-2X_i\bar{X}+\bar{X}^2\\&=\frac{1}{n-1}[(\sum\limits_{i=1}^{n}X_i^2)-2(\bar{X}\sum\limits_{i=1}^{n}X_i)+n\bar{X}^2]\\&=\frac{1}{n-1}\sum\limits_{i=1}^{n}\end{align*}$
