...
---
设二次型$f(x_1,x_2,x_3)=2(a_1x_1+a_2x_2+a_3x_3)^2+(b_1x_1+b_2x_2+b_3x_3)^2,$记$\alpha=\begin{bmatrix}a_1 \\ a_2 \\ a_3\end{bmatrix},\beta=\begin{bmatrix}b_1 \\ b_2 \\ b-3\end{bmatrix}.$
（1）证明二次型$f$对应的矩阵为