...
---
答案：$k\ne9,x=c_1\begin{bmatrix}1 \\ 2 \\ 3\end{bmatrix}+c_2\begin{bmatrix}3 \\ 6 \\ k\end{bmatrix};k=9,r(A)=2,x=c_1\begin{bmatrix}1 \\ 2 \\ 3 \\ \end{bmatrix};k=9,r(A)=1,x=c_1\begin{bmatrix}-b \\ 0 \\ a\end{bmatrix}+c_2\begin{bmatrix}-c \\ 0 \\ a\end{bmatrix}$
